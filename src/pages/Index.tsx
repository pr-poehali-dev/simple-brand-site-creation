...
const audiences = [
  ...
  { icon: "BookOpen", label: "Школьники", desc: "Простые объяснения, геймификация, мотивация" },
  { icon: "Briefcase", label: "Профессионалы", desc: "Прокачка навыков, новые компетенции, карьерный рост" },
